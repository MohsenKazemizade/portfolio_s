      ...
      >
        ...
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="details">
            ...
            <a href="#" target="_blank" className="custom-btn" rel="noreferrer">
              <span>
          ...
          <div className="main-content">
            ...
            >
              <SwiperSlide className="swiper-slide">
                <img src="/assets/portfolio/project-2.jpg" title="img" alt="" />
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <img src="/assets/portfolio/project-3.jpg" title="img" alt="" />
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <img src="/assets/portfolio/project-1.jpg" title="img" alt="" />
              </SwiperSlide>
